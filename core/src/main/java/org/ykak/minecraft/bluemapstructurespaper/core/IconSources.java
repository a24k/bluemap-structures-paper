...
public final class IconSources {
  ...
  private static final Map<String, String> PATHS =
      Map.ofEntries(
          Map.entry("village", TEXTURES_ROOT + "item/emerald.png"),
          ...
          Map.entry("ruined_portal", TEXTURES_ROOT + "block/crying_obsidian.png"),
          Map.entry("monument", TEXTURES_ROOT + "block/sponge.png"),
          ...
          Map.entry("ruined_portal_nether", TEXTURES_ROOT + "block/obsidian.png"),
